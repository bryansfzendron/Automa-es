...
caminho = (r'C:/Gdrive/Dados_Publicos_SP/Saude/Vacinacao/DistribuicaoDeDoses.csv')
dataArquivo = str(datahj.strftime("%d-%m-%Y"))
nmArquivo = str(datahj.strftime("DistribuicaoDosesV2.py - %d_%m_%Y.txt"))
DataEmail = str(datahj.strftime("%d/%m/%Y - %H:%M:%S"))
url = f'https://www.saopaulo.sp.gov.br/wp-content/uploads/{anoO}/{mesO}/{dataontem}_painel_distribuicao_doses.csv'
...
def enviaEmail():
    ...
    enviarEmail['subject'] = "Erro na Execução DistribuicaoDosesV2.py na data "+DataEmail
