...
caminho = (r'C:/Gdrive/Dados_Publicos_SP/Saude/Vacinacao/RankingVacinacao.csv')
dataArquivo = str(datahj.strftime("%d-%m-%Y"))
nmArquivo = str(datahj.strftime("RankingVacinacaoV2.py - %d_%m_%Y.txt"))
DataEmail = str(datahj.strftime("%d/%m/%Y - %H:%M:%S"))
url = f'https://www.saopaulo.sp.gov.br/wp-content/uploads/{anoO}/{mesO}/{dataontem}_percentual_primeira_dose.csv'
...
def enviaEmail():
    ...
    enviarEmail['subject'] = "Erro na Execução RankingVacinacaoV2.py na data "+DataEmail
