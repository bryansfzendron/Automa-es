...
caminho = (r'C:/Gdrive/Dados_Publicos_SP/Saude/Vacinacao/vacinometro.csv')
dataArquivo = str(datahj.strftime("%d-%m-%Y"))
nmArquivo = str(datahj.strftime("VacinometroV2.py - %d_%m_%Y.txt"))
DataEmail = str(datahj.strftime("%d/%m/%Y - %H:%M:%S"))
url = f'https://www.saopaulo.sp.gov.br/wp-content/uploads/{anoO}/{mesO}/{dataontem}_vacinometro.csv'
...
def enviaEmail():
    ...
    enviarEmail['subject'] = "Erro na Execução VacinometroV2.py na data "+DataEmail
